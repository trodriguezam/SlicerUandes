...
- Setting up your git account:
  ...
  - If not already done, email `FirstName LastName <firstname.lastname@Uandes.com>` to be granted access to
    the [Uandes/SlicerUAndes](https://github.com/Uandes/SlicerUAndes) repository.
...
mkdir W
cd /c/W
git clone https://github.com/Uandes/SlicerUAndes.git S
```
