# Build and Package SlicerUandes

This document summarizes how to build and package SlicerUandes on Windows.

SlicerUandes is a custom Slicer application. Reading the [3D Slicer Developer Documentation](https://slicer.readthedocs.io/en/latest/developer_guide/index.html) may help answer additional questions.
...
- Setting up your git account:
  ...
  - If not already done, email `FirstName LastName <firstname.lastname@trodriguezam.com>` to be granted access to
    the [trodriguezam/SlicerUandes](https://github.com/trodriguezam/SlicerUandes) repository.
...
mkdir W
cd /c/W
git clone https://github.com/trodriguezam/SlicerUandes.git S
```
...
4. Open `C:\W\SR\SlicerUandes.sln`, select `Release` and build the project.
