# Contributing to SlicerUandes

There are many ways to contribute to SlicerUandes.

- Submit a feature request or bug, or add to the discussion on the [SlicerUandes issue tracker][is]
- Submit a [Pull Request][pr] to improve SlicerUandes.

## The PR Process, and Related Gotchas

### How to submit a PR ?

If you are new to SlicerUandes development and you don't have push access to the SlicerUandes
...
When submitting a PR, make sure to add a `Cc: @SlicerUandes/developers` comment to
notify SlicerUandes developers of your awesome contributions. Based on the
...
- You do NOT have push access: A SlicerUandes core developer will integrate your PR.
...
[pr]: https://github.com/trodriguezam/SlicerUandes/merge_requests
[is]: https://github.com/trodriguezam/SlicerUandes/issues
